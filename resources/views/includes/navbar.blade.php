    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        @auth
            ...
            <ul class="navbar-nav d-none d-lg-flex">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="{{ route('seller') }}" class="dropdown-item">Dashboard</a>
                        <a href="{{ route('seller-settings-account') }}" class="dropdown-item">
                            Settings
                        </a>
            ...
            <ul class="navbar-nav d-block d-lg-none">
                ...
                <li class="nav-item">
                    <a href="{{ route('keranjang') }}" class="nav-link d-inline-block">
                        Keranjang
                    </a>
                </li>
            </ul>    
